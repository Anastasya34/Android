...
public class UserMyBooksFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        selectProposalReceiver = new UserMyBooksFragment.RequestResultReceiver(new Handler());
        selectBookReceiver = new UserMyBooksFragment.RequestBookReceiver(new Handler());
    ...
    public void onClickReturnBook(int position, View v){
        updateProposalReceiver = new UserMyBooksFragment.UpdateProposalReceiver(new Handler());
            ...
            switch (resultCode) {
                ...
                case DbService.REQUEST_SUCCESS:
                    ...
                    try {
                        ...
                        mAdapter = new ProposalAdapter(rootView.getContext(),proposals, bookReturnClickListener, "UserMyBooksFragment");
