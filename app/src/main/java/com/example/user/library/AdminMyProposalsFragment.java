...
public class AdminMyProposalsFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("AdminMyProposalsFragmen", String.valueOf(getArguments()));
    ...
    public static AdminMyProposalsFragment newInstance(int page) {
        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, page);
        AdminMyProposalsFragment fragment = new AdminMyProposalsFragment();
