...
public class AdminMyProposals_ReturnProposalsFragment extends Fragment{
    ...
    private String proposalType = "AdminMyProposals_ReturnProposalsFragment";
    ...
    String querySelectProposals = "SELECT proposal_id, book1_id, bookstatus, fk_userreader, issuedate FROM [proposal] WHERE fk_admin = %s AND bookstatus = 6";
    String querySelectBook = "SELECT book_id, bookname FROM [book] WHERE book_id IN ";
    String queryUpdateProposal = "UPDATE [proposal] SET bookstatus = 7 WHERE proposal_id = %s;";
